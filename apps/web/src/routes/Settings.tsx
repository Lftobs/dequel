	...
	return (
		<div className="mx-auto max-w-6xl space-y-8 pb-12">
			...
			<Tabs defaultValue="servers" className="space-y-6">
				<TabsList className="bg-card/60 border border-border/60 p-1 rounded-2xl backdrop-blur-md max-w-lg flex overflow-x-auto whitespace-nowrap justify-start [scrollbar-width:none] [&::-webkit-scrollbar]:hidden touch-pan-x">
					<TabsTrigger
						value="servers"
