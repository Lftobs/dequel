			...
			<CardHeader className="border-b border-border/40 pb-5">
				<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
					<div className="flex items-center gap-3">
						<div className="flex h-10 w-10 items-center justify-center rounded-xl bg-zinc-900 text-white ring-1 ring-zinc-700">
						...
						<ol className="text-xs text-muted-foreground space-y-2 list-decimal list-inside leading-relaxed">
							...
							<li>
								...
								<div className="mt-1.5 flex items-center gap-2">
									<code className="rounded-xl border border-border/80 bg-black/60 px-3 py-1.5 font-mono text-[11px] text-zinc-300">
										{callbackUrl}
									</code>
									<Button
										type="button"
