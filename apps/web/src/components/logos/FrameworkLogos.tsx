...
export function AngularLogo({ className = 'h-4 w-4', size, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 250 250" className={className} width={size} height={size} {...props}>
      ...
      <path fill="#FFFFFF" d="M125,52.1L66.8,182.6h21.7l11.7-29.2h49.4l11.7,29.2h21.7L125,52.1z M125,92l17.7,44.2h-35.4L125,92z" />
    </svg>
  );
}
...
export function RemixLogo({ className = 'h-4 w-4', size, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 100 100" className={className} width={size} height={size} {...props}>
      ...
      <path d="M22 30h32a18 18 0 0118 18c0 7.8-5 14.4-12 16.8L72 80H54L42 66H36v14H22V30zm14 14v10h16a5 5 0 100-10H36z" fill="#E8F1F5" />
...
export function getFrameworkLogo(icon: string, className = 'h-4 w-4'): React.ReactNode {
  ...
  if (iconLower.includes('python') || iconLower.includes('django') || iconLower.includes('fastapi')) return <PythonLogo className={className} />;
