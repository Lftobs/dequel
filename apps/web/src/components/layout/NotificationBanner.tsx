	...
	return (
		<div className="fixed bottom-6 left-6 right-6 md:left-auto md:right-6 z-[999999] w-auto md:w-full md:max-w-sm animate-in fade-in slide-in-from-bottom-5 duration-300">
			...
			>
				...
				<div>
					<AlertTitle className="text-zinc-200 font-bold capitalize text-xs mb-1">{notification.type}</AlertTitle>
					<AlertDescription className="text-zinc-400 text-xs leading-relaxed">{notification.message}</AlertDescription>
				</div>
				<button
					onClick={onClose}
					type="button"
