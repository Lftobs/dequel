import { Box, Container, FolderCode, Globe, Play, Plus, Sliders, Terminal, Trash2 } from "lucide-react";
				...
				<div className="space-y-4 pt-4 border-t border-[#1a1a22]">
					...
					<div className="space-y-2">
						{composeServicesList.map((row) => (
							<div
								key={row.id}
								className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 p-3 rounded-xl bg-[#121215] border border-[#22222a]"
							>
								<div>
