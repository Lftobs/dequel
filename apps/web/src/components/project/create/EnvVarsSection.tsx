		...
		<div className="space-y-4 bg-[#0d0d10] border border-[#1f1f26] p-5 sm:p-6 rounded-2xl shadow-lg">
			...
			>
				<div>
					...
					<p className="text-xs text-zinc-400 mt-1">Add environment secrets, API keys, and configuration variables.</p>
				</div>
				<button
					type="button"
				...
				>
					<ChevronDown
						className={`h-4 w-4 transition-transform ${isExpanded ? "transform rotate-180 text-orange-400" : ""}`}
					/>
				</button>
			</div>
