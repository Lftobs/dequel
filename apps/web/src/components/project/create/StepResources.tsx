...
export function StepResources({ cpuLimit, setCpuLimit, memoryLimitMb, setMemoryLimitMb }: StepResourcesProps) {
	return (
		<div className="space-y-6">
			...
			<div className="grid gap-4 text-xs sm:grid-cols-2">
				<div className="grid gap-1.5">
					<label htmlFor="cpuLimit" className="font-semibold text-zinc-400">
						Maximum CPU cores
					</label>
					<Input
						id="cpuLimit"
						...
						className="h-9 border-[#222227] bg-[#141418] font-mono text-zinc-200 focus:border-amber-500"
					/>
				</div>
				<div className="grid gap-1.5">
					<label htmlFor="memoryLimitMb" className="font-semibold text-zinc-400">
						Maximum RAM (MB)
					</label>
					<Input
						id="memoryLimitMb"
