...
SELECT `id`, `project_id`, `database_name`, `type`, `version`, `database_name`, `username`, `password`, `internal_host`, `internal_port`, `cpu_limit`, `memory_limit_mb`, NULL, 0, 0, 0, '[]', NULL, NULL, 'db-' || substr(`id`, 1, 12), `connection_string`, `status`, `container_name`, `created_at`, `updated_at` FROM `databases`;--> statement-breakpoint
